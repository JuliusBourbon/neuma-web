export default function LockIcon({ className = "w-4 h-4", ...props }) {
    return (
        <svg
        ...
        >
            <g clipPath="url(#clip0_4418_8318)">
                ...
                <path d="M11.9999 15.1004C12.6074 15.1004 13.0999 14.6079 13.0999 14.0004C13.0999 13.3929 12.6074 12.9004 11.9999 12.9004C11.3924 12.9004 10.8999 13.3929 10.8999 14.0004C10.8999 14.6079 11.3924 15.1004 11.9999 15.1004Z" />
