...
export default function RegisterPage({ onClose, onSwitchToLogin }) {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const data = await register({ email, password, username: username.trim() || undefined });
    ...
    const handleGoogleError = (errorResponse) => {
        setErrorMessage(errorResponse?.error_description || "Login dengan Google dibatalkan atau terjadi kesalahan.");
    };
    ...
    return (
        <div className="relative bg-primary min-h-screen w-full flex flex-col items-center justify-center p-8 md:p-16">
            ...
            <div className="flex flex-col items-center gap-6 mb-16 md:mb-20 text-center">
                ...
                <h3 className="text-xl md:text-2xl font-semibold text-secondary">Open your world with Sign Language, Today!</h3>
            </div>

            <div className="flex flex-col items-center gap-6 w-full max-w-md">
                <h3 className="text-2xl font-medium text-tertiary">Create your profile</h3>
                ...
                <h3 className="text-sm font-medium text-tertiary">By signing up to Neumá, you agree to our <span className="font-bold underline">Terms</span> and <span className="font-bold underline">Privacy Policy</span></h3>
            </div>
        </div>
    );
}
