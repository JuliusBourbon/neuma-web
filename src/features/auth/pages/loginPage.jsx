    ...
    return (
        <div className="relative bg-primary min-h-screen w-full flex flex-col items-center justify-center p-8 md:p-16">
            ...
            <div className="flex flex-col items-center gap-6 w-full max-w-md">
                ...
                <h3 className="text-sm font-medium text-tertiary">By signing in to Neumá, you agree to our <span className="font-bold underline">Terms</span> and <span className="font-bold underline">Privacy Policy</span></h3>
            </div>
        </div>
    );
}
